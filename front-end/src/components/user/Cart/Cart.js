  ...
  let loadedCart = props.loadedMyCart.map((item, index) => (
    <tr className="row-box" key={index}>
      ...
      <td>
        ...
        <div className="d-flex flex-row">
          <div className="text-move-to-favourite">Move to Favourite</div>
        </div>
      </td>
      <td>
        <div className="d-flex flex-row">
    ...
    <div className="cart">
      <div className="container">
        <div
          ...
          role="alert"
        >
          <strong style={{ fontWeight: "600", paddingRight: "0.3rem" }}>
            HAVE A PROMO CODE?
          </strong>
          You will be able to apply it on the payment page during checkout.
          <button
            type="button"
            className="close"
            data-dismiss="alert"
                ...
                <div className="summary-box">
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="pr-2">
                        <div className="sub-total">
                          Item(s) x{props.loadedMyCart.length}
                        </div>
                      </div>
                      <div className="pl-2">S${totalCartAmount.toFixed(2)}</div>
                    </div>
                  </div>
                  ...
                  <div className="additional-fee-wrapper">
                    <div className="d-flex justify-content-between">
                      ...
                      <div className="pl-2">
                        <div className="text-shipping">S$4.00</div>
                      </div>
                    </div>
                  </div>
